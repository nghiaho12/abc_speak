...
# openblas first
cd $WORKDIR
git clone -b v0.3.28 --single-branch https://github.com/xianyi/OpenBLAS
...
CXX=$CXX AR=$AR RANLIB=$RANLIB CXXFLAGS="$ARCHFLAGS -O3 -D__EMSCRIPTEN__ -DFST_NO_DYNAMIC_LINKING -D__EMSCRIPTEN__" ./configure --use-cuda=no \
